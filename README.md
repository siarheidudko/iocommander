...
#### v1.1.0
- добавлен контроль версии для клиентов и сервера
- реализован вывод версии в веб-панель администрирования
- изменен отчет по онлайну (в вертикальную ориентацию)
 
#### v1.1.4
- перенесена генерация дополнительной задачи (выполнение скачанного файла) в функцию setTask
- в задании скачать файл в папку/передать файл - можно не вводить каталог, тогда он по умолчанию будет /tmp/iocom/ или C:\tmp\iocom\ для linux и windows соответственно.
- начата разработка RESTFull-api

#### v1.1.5
- веб-сервер переписан на потоковую отдачу
- увеличен таймаут пинга вебсокета с 1ч до 2ч
