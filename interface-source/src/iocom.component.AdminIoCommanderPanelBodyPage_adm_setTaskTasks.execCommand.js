...
class execCommand extends React.Component{
	...
	onBtnClickHandler(e){
		if(e.target.id === 'submit'){
			if(typeof(window.socket) !== 'undefined'){
				...
				&& (typeof(store.adminpanelStorage.getState().task.command) === 'string') && (store.adminpanelStorage.getState().task.command !== '') 
				...
				&& (typeof(store.adminpanelStorage.getState().task.dependencies) === 'object') && (typeof(store.adminpanelStorage.getState().task.tradeobj) === 'object')){
					...
					var tempTask = {
						...
						task: {
							...
							execCommand:store.adminpanelStorage.getState().task.command, 
