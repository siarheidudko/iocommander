		...
		switch(e.target.name){
			case 'CommandType':
				if(e.target.id === 'adm_setTask'){
					this.setState({CommandType: e.target.id,ParamOne: core.generateUID(),ParamTwo: '',ParamThird: '',ParamFour: '',ParamFive: '',ParamSix: '',ParamSeven: new Array,ParamEight: new Array,ParamNine: '',ParamTen: '',ParamEleven: '',ParamTwelve: false});
				} else {
